...
- Reduced unnecessary horizontal scrollbars in control and plugin panels (#85): overflow-prone wrappers now use shrink-safe constraints (`max_width: 97%`, `min_width: 0`, `box_sizing: border-box`) across the main control UI, wide footer panel, chart/heatmap/ROI/export plugin sections, and annotation palette editor.
