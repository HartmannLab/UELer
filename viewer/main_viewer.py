...
# Import modules
from constants import PREDEFINED_COLORS, DOWNSAMPLE_FACTORS, UICOMPNENTS_SKIP
...
from viewer.annotation_palette_editor import AnnotationPaletteEditor
from viewer.color_palettes import (
    DEFAULT_COLOR,
    ...
    def dynamically_load_plugins(self):
        ...
        for filename in os.listdir(plugin_dir):
            if filename.endswith('.py') and not filename.startswith('_'):
                ...
                module_path = f"viewer.plugin.{module_name}"
