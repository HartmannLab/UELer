...
from viewer.color_palettes import DEFAULT_COLOR, normalize_hex_color


class AnnotationPaletteEditor(VBox):
    """Widget allowing users to assign colors and labels to annotation classes."""
    ...
    def __init__(
        ...
        self._grid = GridBox(layout=Layout(grid_template_columns="repeat(3, minmax(120px, 1fr))", gap="6px"))
