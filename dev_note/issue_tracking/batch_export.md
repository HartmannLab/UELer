...
- [x] Fix issue where scale bar length calculation does not account for downsample factor correctly, leading to undersized scale bars even in the main viewer.

#### Phase 4a Action Plan (2025-10-24)
